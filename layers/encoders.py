...
class TSTiEncoder(nn.Module):  
    ...
    def forward(self, x) -> Tensor: 
        ...
        '''
        shape of pf the z= torch.Size([16, 6, 16, 15])
        shape of pf the z= torch.Size([16, 6, 16, 12])
        shape of pf the z= torch.Size([16, 6, 16, 7])
        shape of pf the z= torch.Size([16, 6, 16, 16])
        shape of pf the z= torch.Size([16, 6, 16, 16])
        '''
        return z
